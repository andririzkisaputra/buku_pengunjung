...
<div class="site-master-data">
  <div class="layout-data-master">
    ...
    <?php if ($model['access_token']): ?>
      <?= Html::a('Refresh Akses Token', ['site/refresh-token?refresh_token='.$model['refresh_token']], ['class' => 'btn btn-sm btn-info']); ?>
    <?php endif; ?>
    <?php if (!$model['access_token']): ?>
      <?= Html::a('Generated Akses Token', ['site/refresh-token?client_id='.$model['client_id']], ['class' => 'btn btn-sm btn-info']); ?>
    <?php endif; ?>
  </div>
  <?php if ($model['access_token']): ?>
    <div class="layout-data-master">
